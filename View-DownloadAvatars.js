	...
	const config =
	{
		info:
		{
			...
			[
				{
					name: "sya",
					discord_id: "704955717723095161",
					github_username: "Ayxsz",
					twitter_username: "ayzpollo"
				}
			],
			version: "2.0.0",
			description: "Sizlere Discord avatarını daha iyi kalite ile gösterme ve indirme aracılığı sağlar..",
		}
	};
